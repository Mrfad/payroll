# Backend\employees\management\commands\cleanup_deleted_employees.py
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            f"Cleaning up employees soft-deleted before {cutoff_date.date()}..."
        )
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"Successfully permanently deleted {count} employees."
                )
            )
