# Backend\payroll\tests\test_middleware.py
import pytest
from django.contrib.auth.models import User
from django.http import HttpResponse
from django.test import RequestFactory

from payroll.middleware import ApiLoggingMiddleware, CurrentUserMiddleware
...
class TestMiddlewares:
    def test_current_user_middleware_authenticated(self):
        ...
        request = RequestFactory().get("/api/v1/companies/companies/")
        request.user = user
