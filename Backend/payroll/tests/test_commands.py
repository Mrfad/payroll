...
from payroll.models import Company, Employee, AttendanceRecord, PayrollRun
...
class TestManagementCommands:
    ...
    @patch('payroll.services.attendance.AttendanceProcessingService.process_pending_logs')
    ...
    @patch('payroll.services.payroll.PayrollCalculationService.calculate_payroll')
