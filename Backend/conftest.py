...
def employee(company, department):
    user = User.objects.create_user(username='emp1', password='password123')
    return Employee.objects.create(user=user, company=company, department=department, base_salary=5000)
